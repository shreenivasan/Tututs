...
$sql="INSERT INTO pass_details(sid,name,college,img,email_id,mobile,inserted_datetime) VALUES('".$new_array['sid']."','".$new_array['name']."','".$new_array['college']."','".$file_name."','".$new_array['email']."','".$new_array['mobile']."','".date("Y-m-d H:i:s")."')";
...
<div style="margin-top:10px;"><center><img id="btnPrint" src="images/print-icon.png"></img></center></div>
</div>
</div>
